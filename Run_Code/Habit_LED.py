# Habit_LED.py
# Sound trigger is receieved via port 17 (pin 11) triggers recording.
# Port 23 drives LED flash.
# 
# Avinash Bala, Oct 2017
import os
import io
import time
import socket
...
GPIO.add_event_detect(17, GPIO.RISING, callback=fireLED, bouncetime=300)
